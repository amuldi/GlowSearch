...
| Last verified Vercel deployment | [https://glow-search-coop7hm0g-amuldis-projects.vercel.app/](https://glow-search-coop7hm0g-amuldis-projects.vercel.app/) |
...
- 마지막으로 수동 검증한 Vercel 고유 배포 URL은 `https://glow-search-coop7hm0g-amuldis-projects.vercel.app`입니다. 실제 사용 주소는 고정 별칭인 `https://glow-search.vercel.app`를 기준으로 합니다.
